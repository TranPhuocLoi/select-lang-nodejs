...
if(trim($name_contact) == '') {
	...
	exit();
} else if(trim($category_contact) == '') {
	echo '<div class="error_message">Please enter your option.</div>';
	exit();
...
$e_body = "$category_contact : You have been contacted by $name_contact with additional message is as follows." . PHP_EOL . PHP_EOL;
$e_content = "\"$message_contact\"" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact via email $email_contact";
...
$userheaders = "From: ttduongtran@gmail.com\n";
$usermessage = "Thank you for contact RevTrading. We will reply shortly!";
mail($address,$usersubject,$usermessage,$userheaders);
